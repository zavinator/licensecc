...
# Note: keep '.md' out of source_suffix - the markdown parser extension
# (myst_parser, formerly recommonmark) registers '.md' itself, and listing
# it here too raises "source_suffix '.md' is already registered".
source_suffix = ['.rst']
...
project = 'Licensecc'
copyright = '2026, Open License Manager'
...
# The canonical tag is emitted natively by the sphinx_rtd_theme from the
# 'pageurl' context variable, which Sphinx computes from 'html_baseurl' -
